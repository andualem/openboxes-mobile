...
public class GenericProductDownloadTask extends AsyncTask<Void, Void, String> {
    ...
    public GenericProductDownloadTask(Context context, Long officerId, Long organizationId, String sessionId, ImageView imageView){
    ...
    protected String doInBackground(Void... voids) {
        try {
            Response<ProductListResponse> response = apiServices.getGenericProduct(sessionId);
