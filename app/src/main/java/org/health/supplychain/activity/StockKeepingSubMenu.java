...
public class StockKeepingSubMenu extends ListActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getListView().setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
                ...
                {
                    case 0:
                        contentOptionIntent = new Intent(getApplicationContext(), BincardListActivity.class);
//						finish();
...
//						finish();
    ...
    private void getListOfContentTitle(){
        ...
        messageDetail.put("title", getString(R.string.product_list));
        messageDetail.put("category", getString(R.string.product_list_detail));
        messageDetailList.add(messageDetail);

        messageDetail = new WeakHashMap<String, String>();
        messageDetail.put("title", getString(R.string.inventory_control_list));
        messageDetail.put("category", getString(R.string.inventory_control_list_detail));
        messageDetailList.add(messageDetail);
